...
PassportConfigurator.prototype.configureProvider = function( name, options ) {
   ...
   */
  if ( authType === 'local' ) {
    self.app.post( authPath, (options.callbackFn ? options.callbackFn( passport, options ) :
    ...
    self.app.get(authPath, (options.callbackFn ? options.callbackFn( passport, options ) :
